...
5. [Forum Rules & Moderation](#5-forum-rules--moderation)
6. [Conflict Resolution](#6-conflict-resolution)
7. [Affiliation Types](#7-affiliation-types)
...
**7. AFFILIATION TYPES** – Summary of available Alchemy AOE Alliance partnerships:
...
| CH-11 | {Map-Organizer}   | Leadership in Sourcing Thematic Random Map Script Families |
| CH-12 | {Map-Consultant}  | Feedback for Custom Map Creations                          |
| CH-13 | {Tournament-Host} | Organization of Competitive Events                         |
| CH-14 | {Scholar}         | General Staff & Approvals                                  |
